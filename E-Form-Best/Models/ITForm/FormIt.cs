...
public partial class FormIt
{
    ...
    [InverseProperty("IdFormItNavigation")]
    public virtual ICollection<ItCapQuyenOchung8> ItCapQuyenOchung8s { get; set; } = new List<ItCapQuyenOchung8>();

    [InverseProperty("IdFormItNavigation")]
    public virtual ICollection<ItCaiDatPhanMem10> ItCaiDatPhanMem10s { get; set; } = new List<ItCaiDatPhanMem10>();
    ...
    [InverseProperty("IdFormItNavigation")]
    public virtual ICollection<ItDangKiTaiKhoanHeThong5> ItDangKiTaiKhoanHeThong5s { get; set; } = new List<ItDangKiTaiKhoanHeThong5>();

    [InverseProperty("IdFormItNavigation")]
    public virtual ICollection<ItDangkiTaiKhoanMayTinh6> ItDangkiTaiKhoanMayTinh6s { get; set; } = new List<ItDangkiTaiKhoanMayTinh6>();

    [InverseProperty("IdFormItNavigation")]
    public virtual ICollection<ItDonLapDatThietBi7> ItDonLapDatThietBi7s { get; set; } = new List<ItDonLapDatThietBi7>();
