-- VN-PD: bo phan xac nhan mieng ngay 21/09/2026 - 4 Laptop deu o Hai Duong va deu can cai Office.
-- Truoc do ca 4 may chua co vi tri va dang bi ghi can_cai_office = 0 theo mac dinh dot 1 (chua tra loi phieu).
-- Thiet bi con lai cua VN-PD (2390 - Tivi) khong thuoc pham vi cau hoi nay, khong dong toi.
-- Chay lai lan hai an toan. Rollback: kk-vnpd-office-haiduong-20260921-rollback.sql
...
(399) /* VN-PD002 - Cao Tu Binh B230679 (David Gao) */,
(657) /* VN-PD007 - Yang Ming V170328 */,
(2191) /* VN-HR073 - Yang Ming V170328 */,
(2192) /* VN-GM000 - Yang Ming V170328 */;
...
WHERE bp.TenBoPhan = N'VN-PD' AND tb.NgayXoa IS NULL;
